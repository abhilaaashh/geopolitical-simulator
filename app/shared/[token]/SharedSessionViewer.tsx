...
import { ArrowLeft, Clock, Target, Calendar, Eye, MessageSquare, Globe } from 'lucide-react';
...
export function SharedSessionViewer({ session }: SharedSessionViewerProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-400">
              ...
              <span>Viewing shared session</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-semibold">Final World State</h2>
          </div>
